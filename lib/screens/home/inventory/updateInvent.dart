...
UpdateInvent({required this.canCook,required this.ingredients});
  ...
  Widget build(BuildContext context) {
    ...
    if(canCook) 
      { return CanUpdate(ingredients: ingredients,);}
 ...
 CanUpdate({required this.ingredients});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
                          ...
                          title: Center(child: Text("Inventory updated successfully!",style: TextStyle(fontWeight: FontWeight.bold),)),
                          content: Column(children: [
                            SizedBox(
                              height: ht*0.15,
                              child: Lottie.network("https://assets9.lottiefiles.com/packages/lf20_bxd6jjcn.json")),
...
class CantUpdate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
                          ...
                          title: Center(child: Text("Can't update inventory!",style: TextStyle(fontWeight: FontWeight.bold),)),
                          content: Column(children: [
