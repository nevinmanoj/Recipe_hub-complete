...
import 'package:untitled/screens/home/sideMenu/history.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () async {
              List<recipeModel> R =
                  await DatabaseService(uid: user!.uid).getFavoriteList();

              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Favorites(R: R)));
            },
          ),
          ListTile(
